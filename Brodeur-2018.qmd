...
**Employement rate**: 
General, through "100 x Log Employment (per capita)", or
Industry-wise, trough", or
...
Difficult topic, no consensus yet and interesting application prospects for states and country.
...
First important source is the Global Terrorism Database (2017), firstly established a counselling company, Pinkerton Global Intelligence Services, and now maintained by the National Consortium for the Study of Terrorism and Responses to Terrorism (START).
...
- number of deaths - number of injured people 
...
- employment during the middle of March
...
**Note**, Governement, military employement, rail transportation, household employement industries are absent

## Additionnal datasets

Additionnal datasets were used to compare findings and test their robustness, the Bureau of Economic Analysis (BEA), the Michigan Survey of Consumer (MSC) and Terror-related news stories

### BEA
As this dataset comes from the Bureau of Economic Analysis, the location of said data is the USA.
Time period is 1970 - 2013, and the information comes from both administrative data and survey.

Main Variable:

- Number of jobs in a country

And the way said variable is measurement is an estimation through other indicators.

Governement and military employement were excluded to facility comparison.

**Note** unpaid family workers and volunteers are counted.

## MSC

Dataset containing information collected by the University of Michigan (USA) between 2000 and 2021.
The information was collected through surveys and the variable measurement are binary ("Yes" or "No").

The main variables are:

* Attitude on actual personal finances
* Attitude on business conditions
* Attitude on futur personal finances
* Attitude on spending expectation for household items

## Terror-related news stories

This dataset is a manually constructed dataset using news from the ABC, CBS, NBS and archives in the United States between 2000 and 2012.
The information and variables were and constructed as manually check with assistants.

The main variables are: 

* Number of news stories related to a TA from the targeted county
* Number of news stories related to a TA without conditioning on location 
* A binary variable being 1 if there at least one news story about the TA, else 0.
* The duration of the news story.
...
Variable such as 'non-american' target and 'logistically international', as well as another variable absorbing employement shocks are taken into account. Estimate of the treatment (SUCESSFUL) is still significant at the 5% level

#### Plausibility

There is a significant negative effect of successfulness of an attack on job/capita. The standard error a half as high as the estimate, indicating confidence in that the estimate is close to the true estimate. The standard error a half as high as the estimate, indicating confidence in that the estimate is close to the true estimate.
