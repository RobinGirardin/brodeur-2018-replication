...
Concerning casualities, for successful terror attacks,
the average amount of death is 4.2 for 3.4 injured, 
while for failed terror attacks, the average death rate is 0.3 for 2.4 injured.
Those estimates excludes Oklahoma City bombing and September 11, 2001.

Concerning property dammage, the mean dammage is approximately 750000$.
However, the property dammage is unkown for more than 2/3 of the sample.
For 25% of the unkown property dammage, another variable qualitatively evaluate said dommage in 3 categories:
* Catastrophic (> $1 billion)
* Major ($1 million – $1 billion), approx. 40 TA
* Minor (< $1 million)
...
#### Plausibility
if the significance levels is 10%, then it is small. However, standard errors are half as big as the estimates, indicating that the estimates is relatively close to the true SUCCESSFUL estimates.
Otherwise, effect at 5% is commendable.
...
In Appendix A8 and A9, he purposefully omits a single year of the data to see wehter the result are influence by few observation.
Since the data spans 44 years, 44 OLS models, each excluding a particular year of the data, were run.
There were no changes in effect.

Estimates and effect are also not driven by attacks on ambiguous locations (hijacking/hostage, mail-based attack).
Also, omitting catastrophic property dommages (outliers) don't affect estimate and effects.

Checking for effects or organization behind the attacks by omitting each of them revealed no change in 
estimate and effects.

Additionnaly, and importantly, there is no evidence that successful attacks lead of the migration out of the county different that 0.
Hence, estimate and effects aren't likely biased by migration.

However, the result and analysis cannot be generalized to other countries, as it is solely based on USA data.
Indeed, USA economy, housing markets and culture is quite unite, hence extrapolating the result to other countries is a mistake.


**Conclusion**

The result are robust to many different samples. Change in samples didn't lead to difference in effects.
Results aren't likely driven by outliers in property dommages, particularly gruesom years, ambiguous location.
Results aren't likely driven by particular terrorist groups.
...
* Meierrieks et al. (2025). “The effect of terrorism on economic inequality in democracies.” Finds that increased terrorist activity is associated with rising income inequality in democracies. [Science Direct Link](https://www.sciencedirect.com/science/article/pii/S0176268024001423?utm_source=chatgpt.com)

* Bardwell & Mohib (2021). “The Economic Impact of Terrorism from 2000 to 2018.”
Uses a cost-accounting approach to estimate global costs of terrorism (deaths, property damage, GDP losses). [De Gruyter link](https://www.degruyterbrill.com/document/doi/10.1515/peps-2020-0031/html?lang=en&srsltid=AfmBOorsQnmkbPkTmSKs5_1Zse2SPNAOumb-Sfibi7GjRCHBpPN5yI0u&utm_source=chatgpt.com)

* Tingbani (2019). “Terrorism and country-level global business failure.” Examines how terrorism affects business failure at the national level. [ScienceDirect link](https://www.sciencedirect.com/science/article/abs/pii/S0148296318304211?utm_source=chatgpt.com)

* Sandler (2025). “An Economic Perspective on Terrorism and Counterterrorism.” Provides a recent overview of the economics of terrorism and counterterrorism policies.
[Taylor & Francis link](https://www.tandfonline.com/doi/abs/10.1080/09546553.2023.2259992?utm_source=chatgpt.com)

* Brodeur (2022). “On the Economic Consequences of Mass Shootings.” Extends the logic of his 2018 terrorism study to mass shootings, analyzing their local economic impact. [RePEc link](https://ideas.repec.org/p/zbw/glodps/1133.html?utm_source=chatgpt.com)
